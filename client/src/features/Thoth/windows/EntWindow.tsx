  ...
  useEffect(() => {
    if (!loaded) {
      (async () => {
        ...
        setXREngineSpellHandlerIncoming(res.data.xrengine_spell_handler_incoming)
  ...
  const update = () => {
    ...
    axios
      ...
      .then(res => {
        ...
        setDiscordSpellHandlerIncoming(responseData.discord_spell_handler_incoming)
        ...
        setXREngineSpellHandlerIncoming(responseData.xrengine_spell_handler_incoming)
        setXREngineSpellHandlerUpdate(responseData.xrengine_spell_handler_update)
