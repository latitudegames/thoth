    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer
        ...
        sx={{
          width: drawerWidth,
          flexShrink: 0,
          [`& .MuiDrawer-paper`]: { width: drawerWidth, boxSizing: 'border-box', background: "rgba(70, 70, 70, 0.95)" },
        }}
      >
        <Toolbar />
...
<Container container spacing={2}>
  ...
  <Grid item xs={1}>
  <OutlineButton variant="outlined" size="medium" fullWidth>Filter</OutlineButton>
  </Grid>
</Container>
