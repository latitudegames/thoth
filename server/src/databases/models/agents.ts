...
export type agentsCreationAttributes = Optional<
  agentsAttributes,
  agentsOptionalAttributes
>

export class agents
  extends Model<agentsAttributes, agentsCreationAttributes>
