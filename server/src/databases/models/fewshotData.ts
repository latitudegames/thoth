...
export interface fewshotDataAttributes {
  id: number;
...
export type fewshotDataOptionalAttributes = "id" | "creator" | "tags" | "createdAt" | "updatedAt" | "deletedAt";
export type fewshotDataCreationAttributes = Optional<fewshotDataAttributes, fewshotDataOptionalAttributes>;

export class fewshotData extends Model<fewshotDataAttributes, fewshotDataCreationAttributes> implements fewshotDataAttributes {
  id!: number;
  fewshotTaskId!: number;
  inputs!: string[];
  outputs!: string[];
