...
import type {
  ...
  fewshotSerializationId,
} from './fewshotSerialization'

export type fewshotTaskAttributes = {
  id: number
  name: string
  numInputs: number
  numOutputs: number
...
export type fewshotTaskOptionalAttributes =
  | 'id'
  | 'unstuffedParentId'
  | 'createdAt'
  | 'updatedAt'
  | 'deletedAt'
export type fewshotTaskCreationAttributes = Optional<
  fewshotTaskAttributes,
  fewshotTaskOptionalAttributes
>

export class fewshotTask
  extends Model<fewshotTaskAttributes, fewshotTaskCreationAttributes>
  implements fewshotTaskAttributes
{
  id!: number
  name!: string
  numInputs!: number
  ...
  setFewshotData!: Sequelize.HasManySetAssociationsMixin<
    fewshotData,
    fewshotDataId
  >
  addFewshotDatum!: Sequelize.HasManyAddAssociationMixin<
    fewshotData,
    fewshotDataId
  >
  addFewshotData!: Sequelize.HasManyAddAssociationsMixin<
    fewshotData,
    fewshotDataId
  >
  createFewshotDatum!: Sequelize.HasManyCreateAssociationMixin<fewshotData>
  removeFewshotDatum!: Sequelize.HasManyRemoveAssociationMixin<
    fewshotData,
    fewshotDataId
  >
  removeFewshotData!: Sequelize.HasManyRemoveAssociationsMixin<
    fewshotData,
    fewshotDataId
  >
  hasFewshotDatum!: Sequelize.HasManyHasAssociationMixin<
    fewshotData,
    fewshotDataId
  >
  hasFewshotData!: Sequelize.HasManyHasAssociationsMixin<
    fewshotData,
    fewshotDataId
  >
  ...
  setFewshotSerializations!: Sequelize.HasManySetAssociationsMixin<
    fewshotSerialization,
    fewshotSerializationId
  >
  addFewshotSerialization!: Sequelize.HasManyAddAssociationMixin<
    fewshotSerialization,
    fewshotSerializationId
  >
  addFewshotSerializations!: Sequelize.HasManyAddAssociationsMixin<
    fewshotSerialization,
    fewshotSerializationId
  >
  createFewshotSerialization!: Sequelize.HasManyCreateAssociationMixin<fewshotSerialization>
  removeFewshotSerialization!: Sequelize.HasManyRemoveAssociationMixin<
    fewshotSerialization,
    fewshotSerializationId
  >
  removeFewshotSerializations!: Sequelize.HasManyRemoveAssociationsMixin<
    fewshotSerialization,
    fewshotSerializationId
  >
  hasFewshotSerialization!: Sequelize.HasManyHasAssociationMixin<
    fewshotSerialization,
    fewshotSerializationId
  >
  hasFewshotSerializations!: Sequelize.HasManyHasAssociationsMixin<
    fewshotSerialization,
    fewshotSerializationId
  >
  ...
  setUnstuffedParent!: Sequelize.BelongsToSetAssociationMixin<
    fewshotTask,
    fewshotTaskId
  >
