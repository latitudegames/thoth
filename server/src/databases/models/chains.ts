...
export type chainsOptionalAttributes =
  ...
  | 'modules'
  | 'gameState'
export type chainsCreationAttributes = Optional<
  chainsAttributes,
  chainsOptionalAttributes
>

export class chains
  extends Model<chainsAttributes, chainsCreationAttributes>
  implements chainsAttributes
{
  id!: string
  name!: string
  chain?: object
