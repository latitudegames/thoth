...
var Code = /** @class */ (function (_super) {
    ...
    Code.prototype.builder = function (node) {
        if (!node.data.code)
            node.data.code = defaultCode;
    ...
    Code.prototype.worker = function (node, inputs, outputs, _a) {
        var silent = _a.silent, data = _a.data;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                try {
                    value = runCodeWithArguments(node.data.code);
                    if (!silent)
                    ...
                    if (!silent)
                        node.display("Error evaluating code.  Open your browser console for more information.");
