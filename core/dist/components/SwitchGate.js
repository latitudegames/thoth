...
var SwitchGate = /** @class */ (function (_super) {
    ...
    SwitchGate.prototype.builder = function (node) {
        ...
        var input = new Rete.Input("input", "Input", anySocket);
        var dataInput = new Rete.Input("trigger", "Trigger", triggerSocket);
        var defaultOutput = new Rete.Input("default", "Default", triggerSocket);
        node.addInput(input).addInput(dataInput).addOutput(defaultOutput);
        return node;
    };
    // the worker contains the main business logic of the node.  It will pass those results
    // to the outputs to be consumed by any connected components
    SwitchGate.prototype.worker = function (node, inputs, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (this._task.closed.includes(input)) {
                    ...
                    this._task.closed = this._task.closed.filter(function (output) { return output !== input; });
                }
                else {
                    // otherwise open up the default output
                    this._task.closed = this._task.closed.filter(function (output) { return output !== "default"; });
                }
                return [2 /*return*/];
            });
        });
